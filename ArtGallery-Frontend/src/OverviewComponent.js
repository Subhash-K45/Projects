        ...
        <>  
           ...
           <div className="OverView-Content">
                <div className="Contemporary-Main_Page">
                    <img src="https://i.etsystatic.com/21122594/r/il/0f3301/2481263476/il_fullxfull.2481263476_ok6w.jpg" alt="Contemporary Image"/>
                ...
                <div className="Sculputures-Main_Page">
                    <img src="https://mikefieldsbronzes.com/wp-content/uploads/2014/12/Unity-Contemporary-Sculpture-Mike-Fields-2.jpg" alt="Sculputures"/>
                    <Link to="/Sculptures">{state[1]}</Link>
                    <p>Discover unusual forms and exciting abstractions.</p>
                </div>
                <div className="Mixed_Art-Main_Page">
                    <img src="https://www.artfulflight.com/wp-content/gallery/mixed-media-paintings/IMG_2961.jpg" alt="Mixed_Art"/>
