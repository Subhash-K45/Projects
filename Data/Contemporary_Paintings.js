const data=[
    { 
     ...
     description:'Art that goes beyond the confines of contemporary art, exploring new directions, aesthetics, or modes of artistic expression.'
    },{
     id:2,
     ...
     artist:'Neo Rauch',
     description:'Art that emerged in the late 20th century, characterized by a rejection of modernist principles and a focus on self-reflection, irony, and the blending of different styles and cultural references.'
},{
     id:3,
     ...
     name:'Fine art',
     artist:'Cecily Brown',
     description:'Art created primarily for aesthetic purposes, often exhibiting technical skill and conceptual depth.'
 },{
     id:4,
     ...
     artist:'Neo Rauch',
     description:'An art movement that emerged in the late 20th century, characterized by bold, gestural brushwork, intense colors, and emotional or psychological subject matters'
 },{
     id:6,
     ...
     name:'Neo-expressionism',
     artist:'Jonas Wood',
     description:' Art that does not attempt to represent recognizable objects or scenes, focusing instead on the interplay of color, form, and texture to evoke emotions or ideas.'
 },{
     id:8,
     ...
     name:'Street art',
     artist:'Neo Rauch',
     description:'Art created in public spaces, often associated with urban environments, including graffiti, murals, stencils, and other forms of artistic expression.'
 },
 {
    id:9,
    ...
    description:' Artistic works created from the late 19th century to the mid-20th century that departed from traditional art forms and embraced experimentation, abstraction, and new techniques.'
 },
 {
     id:10,
     ...
     artist:'Peter Doig',
     description:'Art inspired by or created within urban environments, often incorporating elements of street art, graffiti, and cultural references specific to urban contexts.'
 },{
     id:11,
     ...
     artist:'Elizabeth Peyton',
     description:': Art that incorporates multiple materials, techniques, or mediums, often combining traditional painting with elements of collage, sculpture, or digital processes.'
 },{
     id:12,
     ...
     description:'Art that pushes the boundaries of artistic conventions, challenging established norms and exploring new artistic concepts and techniques.'
 },{
     id:13,
     ...
     description:'Paintings that incorporate innovative approaches, techniques, and subject matters, often departing from traditional artistic conventions.'
 },{
     id:15,
     ...
     name:'Digital art',
     artist:'Jenny Saville',
     description:'Art created or presented using digital technologies, such as digital painting, computer-generated imagery, interactive installations, or digital prints.'
 },{
     id:17,
     ...
     artist:'Peter Doig',
     description:'Art created by artists living and working in the present time, reflecting current cultural, social, and political contexts.'
 },{
     id:19,
     ...
     description:' Art that embraces new ideas, styles, or approaches, often with a focus on pushing artistic boundaries and societal norms.'
 },{
     id:20,
     ...
     name:'Minimalism',
     artist:'Jonas Wood',
     description:'Art characterized by simplicity, austerity, and a reduction of form, often focusing on geometric shapes, clean lines, and a sense of precision or repetition.'
 },{
     id:22,
     ...
     name:'Surrealism',
     artist:'Peter Doig',
     description:'entury, emphasizing the irrational, subconscious, and dreamlike elements in art, often creating bizarre or uncanny imagery.'
 },{
     id:23,
     ...
     name:'Wall Art',
     artist:'Neo Rauch',
     description:'Art that emerged in the 1950s and 1960s, characterized by the use of popular imagery, consumer culture references, and vibrant colors, often challenging the boundaries between high art and mass culture.'
 },{
     id:25,
     ...
     name:'female Figurative Art',
     artist:'Luc Tuymans',
     description:' Art that depicts recognizable objects or figures, often exploring themes of identity, representation, and the human form.'
 }
 ]
 module.exports=data